...
*Remember* to substitute the userXY

....
$ oc new-project scm-web-hooks-userXY --display-name="Test WebHooks"
....

*Step 2: Create new application*

* We will use the forked repository from the previous lab https://github.com/RedHatWorkshops/bluegreen
...
....
$ oc expose service scm-web-hooks --hostname=scm-web-hooks.UserName.<<RouteDomainSuffix>>
NAME            HOST/PORT                                  PATH      SERVICE         LABELS              TLS TERMINATION
scm-web-hooks   scm-web-hooks.UserName.<<RouteDomainSuffix>>       scm-web-hooks   app=scm-web-hooks   
....

*Step 5: Test the application*

* Use the newly created route, in the above case
`scm-web-hooks.UserName.<<RouteDomainSuffix>>` and paste it in your browser.
* You should see:
