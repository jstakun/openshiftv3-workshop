...
with `/dbtest`
(http://bootapp-spring-userXY.apps.route.domain.suffix/dbtest
...
`http://bootapp-spring-userXX.apps.devday.ocpcloud.com/`
...
`http://bootapp-spring-userXX.apps.devday.ocpcloud.com/dbtest`
