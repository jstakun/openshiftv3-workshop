...
....
$ oc new-app redhat-openjdk18-openshift:1.2~https://github.com/RedHatWorkshops/spring-sample-app --name=bootapp --build-env=MAVEN_MIRROR_URL=http://nexus.devtools.svc:8081/repository/maven-all-public/
