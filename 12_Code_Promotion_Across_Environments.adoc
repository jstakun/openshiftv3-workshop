...
Name the first project *development-userXY* 

....
$ oc new-project development-userXY
....

Name the second *testing-userXY*. 
....
$ oc new-project testing-userXY
....
...
....
$ oc policy add-role-to-group system:image-puller system:serviceaccounts:testing-userXY -n development-userXY
....

*Step 3: Create an application in the development project*

Switch over to the *development-userXY* project and deploy an
...
welcome-php   docker-registry.default.svc:5000/development-userXY/welcome-php
....
...
Name:			welcome-php
Namespace:		development-userXY
Created:		7 minutes ago
Labels:			app=welcome-php
Annotations:		openshift.io/generated-by=OpenShiftNewApp
			openshift.io/image.dockerRepositoryCheck=2017-08-21T23:24:26Z
Docker Pull Spec:	docker-registry.default.svc:5000/development-userXY/welcome-php
Unique Images:		1
Tags:			1
...
latest
  ...
  * docker-registry.default.svc:5000/development-userXY/welcome-php@sha256:157334d73dfc8dfdf733257b05c3fecaee236d36f69afa207395715fbe882abf
      4 minutes ago
...
....
oc tag FullImageId development-userXY/myapp:promote-qa
....
...
$ oc tag \
docker-registry.default.svc:5000/development-userXY/welcome-php@sha256:157334d73dfc8dfdf733257b05c3fecaee236d36f69afa207395715fbe882abf \
development-userXY/welcome-php:promote-qa

Tag welcome-php:promote-qa set to docker-registry.default.svc:5000/development-userXY/welcome-php@sha256:157334d73dfc8dfdf733257b05c3fecaee236d36f69afa207395715fbe882abf.
...
promote-qa
  tagged from docker-registry.default.svc:5000/development-userXY/welcome-php@sha256:157334d73dfc8dfdf733257b05c3fecaee236d36f69afa207395715fbe882abf
...
....
oc project testing-userXY
oc new-app development-userXY/welcome-php:promote-qa
...
Content of this lab will be used further in lab 18 "Creating a CI/CD Pipeline"
