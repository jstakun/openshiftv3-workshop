...
(https://github.com/jstakun/time). The `rhel1` folder from this github
...
starts off with `registry.access.redhat.com/ubi7/ubi` image. It copies the
...
....
$ oc new-app https://github.com/jstakun/time --context-dir=rhel1

--> Found Docker image 1d309a6 (6 weeks old) from registry.access.redhat.com for "registry.access.redhat.com/ubi7/ubi"

    * An image stream will be created as "ubi:latest" that will track the source image
    * A Docker build using source code from https://github.com/jstakun/time will be created
...

{
    ...
    "spec": {
        ...
        "source": {
            "type": "Git",
            "git": {
                "uri": "https://github.com/jstakun/time"
            },
            "contextDir": "rhel1"
        },
        "strategy": {
