...
MAVEN_MIRROR_URL: http://nexus3.devtools.svc:8081/repository/maven-public/
....
...
ks        ks-myjbossapp-userXX.<<DefaultRouteSuffix>>                                 ks     8080-tcp   
....
...
....
$ curl ks-myjbossapp-userXX.<<DefaultRouteSuffix>>
...
Go to https://ks-myjbossapp-userXX.apps.osecloud.com via your browser.
