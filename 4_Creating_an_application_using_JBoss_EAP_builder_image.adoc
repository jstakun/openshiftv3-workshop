...
Ex:-   http://nexus3.devtools:8081/repository/maven-public/
....
...
Check in EAP pod log what is value of -Xms -Xmx jvm parameters

Add to EAP deployment descriptor environment variable Name: CONTAINER_HEAP_PERCENT Value: 0.9
