...
Ensure you are in the `spring-userXY` project. *Substitute UserName
...
....
    ...
    spring.datasource.url= jdbc:postgresql://postgresql.spring-userXY:5432/sampledb
...
`http://bootapp-spring-userXY.apps.devday.ocpcloud.com/`. It will open
...
....
$ curl -X POST http://bootapp-spring-userXY.apps.devday.ocpcloud.com/refresh
...
....
connection url: jdbc:postgresql://postgresql.spring-userXY:5432/sampledb
....
