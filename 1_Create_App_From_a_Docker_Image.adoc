...
*Note:* Please replace *userXX* with the username assigned to you in
the commands below.
...
Docker Hub that just says ''Welcome to OpenShift V3''. Let us just use
...
....
$ oc expose service welcome --name=welcome --hostname=welcome.userXX.<<RouteDomainSuffix>>

NAME      HOST/PORT                              PATH      SERVICE   LABELS
welcome   welcome.userXX.<<RouteDomainSuffix>>    welcome   
....
...
....
$ curl -Is http://welcome.userXX.<<RouteDomainSuffix>>
....
