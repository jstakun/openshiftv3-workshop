...
....
$ oc expose service welcome --name=welcome --hostname=welcome.userXX.<<DomainNameSuffix>>

NAME      HOST/PORT                     PATH      SERVICE   LABELS
welcome   welcome.userXX.apps.osecloud.com             welcome   
....
...
....
$ curl -Is http://welcome.userXX.<<DomainNameSuffix>>
....
